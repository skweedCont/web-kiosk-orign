...
function App() {
    ...
    const handleOrderSubmit = (order) => {
        if (items.length === 0) {
            ...
            console.log("order.phoneNumber : " + order.phoneNumber);
            console.log("order.re : " + order.receiveType);
    ...
    return (
        <div className="container-fluid">
            <div className="row justify-content-center m-4">
                <h1 className="text-center">STARBUCKS</h1>
            </div>
            <div className="card">
                <div className="row">
                    ...
                    <div className="col-md-4 summary p-4">
                        <Summary items={items} onOrderSubmit={handleOrderSubmit} setItems={setItems}/>
                    </div>
                </div>
            </div>
        </div>
